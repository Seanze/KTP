    ...
    <div>
      <div class="view-home">
        <div class="home-content">
          <div class="header-common-border hasborder">
            <div class="top-handler">
              <h2 class="left">置顶课程</h2>
              <div class="right">
                <el-button type="primary" @click="handleEnterCourse">+ 加入课程</el-button>
              </div>
            </div>
            <el-row :gutter="45" style="margin-top: 15px;">
